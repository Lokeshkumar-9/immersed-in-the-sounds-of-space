...
def plot_geo_with_size(df):
    fig = px.scatter_geo(df, lat='latitude', lon='longitude', size='mass', color='class_cat', projection='orthographic', color_discrete_map=class_colors, custom_data=['mass', 'year', 'name'])
